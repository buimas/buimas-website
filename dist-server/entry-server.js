...
const HireTalent = () => {
  return /* @__PURE__ */ jsx("main", { className: "pt-8 md:pt-12", children: /* @__PURE__ */ jsx(ContactSection, {}) });
};
const Privacy = () => {
  return /* @__PURE__ */ jsx("main", { className: "w-full bg-white px-6 md:px-10 lg:px-[100px] pt-36 pb-24", children: /* @__PURE__ */ jsxs("div", { className: "mx-auto max-w-3xl", children: [
